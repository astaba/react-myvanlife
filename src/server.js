...
createServer({
  ...
  seeds(server) {
    ...
    server.create("user", { id: "123", email: "a@a.com", password: "aqwx", name: "Alpine" })
  },
  ...
  routes() {
    ...
    this.get("/vans/:id", (schema, request) => {
      ...
      // return new Response(400, {}, {error: "Error fetching van details data"})
      return schema.vans.find(id)
    })

    this.get("/host/vans", (schema, request) => {
      // Hard-code the hostId for now
      // return new Response(400, {}, {error: "Error fetching host vans data"})
    ...
    this.get("/host/vans/:id", (schema, request) => {
      // Hard-code the hostId for now
      const id = request.params.id
      // return new Response(400, {}, {error: "Error fetching host van details data"})
